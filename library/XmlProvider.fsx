(**
// can't yet format YamlFrontmatter (["category: Type Providers"; "categoryindex: 1"; "index: 4"], Some { StartLine = 2 StartColumn = 0 EndLine = 5 EndColumn = 8 }) to pynb markdown
...
val data : XmlProvider<...>.CensusApi =
  <census-api xmlns="http://thedataweb.rm.census.gov/api/discovery/" xmlns:dcat="http://www.w3.org/ns/dcat#" xmlns:dct="http://purl.org/dc/terms/" xmlns:pod="https://project-open-data.cio.gov/v1.1/schema/" xmlns:foaf="http://xmlns.com/foaf/0.1/" xmlns:org="http://www.w3.org/ns/org#" xmlns:vcard="http://www.w3.org/2006/vcard/ns#">
    <dct:dataset vintage="1999" geographyLink="https://api.census.gov/data/1999/nonemp/geography.xml" variablesLink="https://api.census.gov/data/1999/nonemp/variables.xml" tagsLi...
val apiLinks : (string * string) [] =
  [|("1999 Nonemployer Statistics: Non Employer Statistics",
     "https://api.census.gov/data/1999/nonemp");
    ("1997 Nonemployer Statistics: Non Employer Statistics",
     "https://api.census.gov/data/1997/nonemp");
    ("1986 County Business Patterns: Business Patterns",
     "https://api.census.gov/data/1986/cbp");
    ("1997 County Business Patterns - Zip Code Business Patterns: T"+[17 chars],
     "https://api.census.gov/data/1997/zbp");
    ("1987 County Business Patterns: Business Patterns",
     "https://api.census.gov/data/1987/cbp");
    ("1999 County Business Patterns - Zip Code Business Patterns: T"+[17 chars],
     "https://api.census.gov/data/1999/zbp");
    ("1988 County Business Patterns: Business Patterns",
     "https://api.census.gov/data/1988/cbp");
    ("2000 County Business Patterns: Business Patterns",
     "https://api.census.gov/data/2000/cbp");
    ("1989 County Business Patterns: Business Patterns",
     "https://api.census.gov/data/1989/cbp");
    ("1990 County Business Patterns: Business Patterns",
     "https://api.census.gov/data/1990/cbp")|]*)
(**
