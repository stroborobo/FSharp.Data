...
let doc = HtmlDocument.Load(googleUrl)(* output: 
val googleUrl : string = "http://www.google.co.uk/search?q=FSharp.Data"
val doc : HtmlDocument =
  <!-- html>--><html lang="en">
  <head>
    <meta charset="UTF-8" /><meta content="/images/branding/googleg/1x/googleg_standard_color_128dp.png" itemprop="image" /><title>FSharp.Data - Google Search</title><script nonce="KSQSs2kQHyMZ8n47DtHwAg==">(function(){
...
let books =
    ...
    |> List.filter(fun (title, href) -> title.Contains("F#"))(* output: 
val fsys : string = "https://www.google.com/search?tbm=bks&q=F%23"
val doc2 : HtmlDocument =
  <!-- html>--><html lang="en">
  <head>
    <meta charset="UTF-8" /><meta content="/images/branding/googleg/1x/googleg_standard_color_128dp.png" itemprop="image" /><title>F# - Google Search</title><script nonce="uAteXu1HJ3mtD0gOMcG5IA==">(function(){
document.documentElement.addEventListener("submit",function(b){var a;if(a=b.target){var c=a.getAttribute("data-submitfalse");a="1"===c||"q"===c&&!a.elements.q.value?!0:!1}else a=!1;a&&(b.preventDefault(),b.stopPropagation())},!0);document.documentElement.ad...
...
let englishLinks =
  englishDoc.CssSelect("a[hreflang|=en]")(* output: 
...
let manElems =
  manDoc.CssSelect("input[name*='man']")(* output: 
...
let file = htmlForm.CssSelect(":file")(* output: 
